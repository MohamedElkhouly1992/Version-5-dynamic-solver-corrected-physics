"""Minimal check for soft-deadband activation, monthly availability, minimum load and fan schedule."""
...
result = run_scenario_model(
    output_dir="example_soft_availability_fan_refinement_output",
